...
export default function PharmacyCard({
    ...
    return (
        <div
            onClick={onSelect}
            className={cn(
                "snap-center min-w-[300px] p-4 rounded-3xl bg-card border border-border/60 shadow-lg transition-all cursor-pointer hover:shadow-xl active:scale-[0.98] duration-300",
